    ...
    <div class="row">
      <div class="col-12  m-b-40">
        <div class="play_today">
          <h3>Roadshow and Mobile Clinic @ Toa Payoh HDB Hub </h3>
            <ul>
              <li><img src="https://i.imgur.com/mc9gYLj.png" style="height: 20px; width: 20px; object-fit: contain"><span style="font-weight: bold; margin-right: 15px;">Location:</span><span>Toa Payoh HDB Hub Mall Atrium</span></li>
              <li><img style="width: 17px" src="https://i.imgur.com/zk1pxl2.png"><span style="font-weight: bold; margin-right: 15px;">Date:</span><span>23 and 24 March 2024</span></li>
              ...
              <li><img src="https://i.imgur.com/jsREBhu.png" style="height: 20px; width: 20px; object-fit: contain"><span style="font-weight: bold; margin-right: 15px;">Address:</span><span>480 Lorong 6 Toa Payoh Singapore 310480 </span></li></ul>
              <hr>
    ...
    <thead class="thead-inverse">
        <tr>
            ...
            <th>Programme^(Free Admission)</th>
				  ...
				  </table><p><strong style="color:blue"><b>Day 1 -23 March 2024, Saturday</b></strong></p><table style="background-color:#fff" class="table table-striped table-inverse table-responsive">
    <thead class="thead-inverse"> 
			<tr>
				</tr></thead><tbody>
            <tr>
                <td scope="row"> 10.00am to 11.30am</td>
							<td><strong>Talk on the Lasting Power of Attorney and Advance Care Planning</strong>
...
</tbody></table><p><strong style="color:blue"><b>Day 2 - 24 March 2024, Sunday</b></strong></p><table style="background-color:#fff" class="table table-striped table-inverse table-responsive">
    <thead class="thead-inverse"> 
			<tr>
				</tr></thead><tbody>
...
<br><br>CPF Members who are ready to make a nomination or want to check their nominations, can do so at the booth (mobile clinic area). Note: Only for members with Singpass. </td>
            ...
            <tr>
              ...
              <td>Sharing about our free legal clinics, upcoming webinars that are available for registration via Zoom or viewing of past webinars on our Youtube channe</td>
            </tr>
            <tr>
                <td scope="row"><strong>Community Justice Centre</strong></td>
              <td>The Community Justice Centre (CJC) is a charity organisation that provides legal and social support for self-represented persons.  
<br><br>Deputyship Assistance Programme seeks to provide assistance and support to individuals applying to be appointed as a deputy via the standard process using the CJC's free online system. </td>
            ...
            <tr>
              ...
              <td>With SNTC, you can plan early and smart for your loved ones with special needs.
					...
					<tr>
                <td scope="row"><strong>Tan Tock Seng Hospital</strong></td>
              <td>Sharing information on ACP and other health programmes.
              </td>
            </tr>
        </tbody>
</table>     
