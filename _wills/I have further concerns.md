...
permalink: /wills-further-concerns/
description: ""
---
<style>
/* cyrillic */
    ...
    <div class="container">
      <div class="row p-t-80 p-b-80">
        <div class="col-6 about_a_b">
                    ...
                    <p>It’s understandable to have loads of burning questions when it comes to making your will. You may have preconceived notions about the significance and process of will-writing – let’s debunk any myths or misinformation before you get started on writing your will.</p>
                    </div>
        </div>
                <div class="col-6 about_a_b">
        ...
        <div class="col-6 about_a_b">
                ...
                <div class="col-6 about_a_b">
                    <div class="inner">
                    <p>Unlike a Lasting Power of Attorney, a will comes into effect only after one has passed on. A will
is a written document that sets out your instructions and wishes on how you want your estate (e.g. your money, property, possessions, and other assets) to be distributed and can be changed at any time as long as you are of sound mind.<br><br>
To help you decide, below are some common myths and questions about writing a will.</p>
                    </div>
        </div>
      </div></div>
  </section>   
                ...
                <ul class="accordion">
                        <li>
                            <label for="accordion_1">
                                <input class="toggle" id="accordion_1" name="accordion" type="radio">I have very few assets, I don’t need a will.
                                <div class="inner">
                            <ul>
                                <li>Wills can be changed at any time.</li>
                                <li>You can write a simple will without a lawyer if you aren’t ready to spend.</li>
                                <li> It’s important to factor CPF proceeds and insurance payouts into your will.</li>
                                    </ul>     
                            
                        </div></label></li>
                        <li>
                            <label for="accordion_2">
                                <input class="toggle" id="accordion_2" name="accordion" type="radio">I need a lawyer to write a will
                                <div class="inner"></div>
                                </label>
                        </li>
                         <li>
                            <label for="accordion_3">
                                <input class="toggle" id="accordion_3" name="accordion" type="radio">The law already dictates my next of kin as my beneficiary. I don’t need a will.
                                <div class="inner"></div>
                         </label></li>
							</ul>
							<h5>Have more questions? <a href="#"><strong>Seek professional legal advice.</strong> </a><br> Try our <a href="#"><strong>Wills Simulator.</strong></a></h5>
            </div>
			</div>
</div>
</section>
