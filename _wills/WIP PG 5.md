   ...
   <div class="container">
      <div class="row p-t-80 p-b-80">
         <div class="col-6 about_a_b">
            <div class="inner">
               <h2>Unsure how to<br> begin? Get started<br> with ease</h2>
               <p>Getting your affairs in order may feel intimidating, especially when it seems like there’s so much to do. It’s not difficult to start writing a Will once you’re armed with the right tools.</p>
            </div>
         </div>
         <div class="col-6 about_a_b">
         ...
         <div class="col-6 about_a_b">
            <div class="inner">
               <h2>Enjoy peace<br>
of mind</h2>
               <p>If you’re feeling overwhelmed, fret not.<br> 
								 Use our <a class="read-more" href="#">Guide to Writing a Will.</a></p>
            </div>
         </div>
		 </div>
            ...
            <ul class="accordion">
               <li>
                  <label for="accordion_1">
                     <input class="toggle" id="accordion_1" name="accordion" type="radio">Making a Will
                     <div class="inner"> </div>
                  </label>
               </li>
               <li>
                  <label for="accordion_2">
                     <input class="toggle" id="accordion_2" name="accordion" type="radio">What happens if I don’t have a Will in place when I die?
                     <div class="inner"> 
                     </div>
                  </label>
               </li>
               <li>
                  <label for="accordion_3">
                     <input class="toggle" id="accordion_3" name="accordion" type="radio">What’s the difference between a Lasting Power
                     <div class="inner"></div>
                  </label>
               </li>
               <li>
                  <label for="accordion_4">
                     <input class="toggle" id="accordion_4" name="accordion" type="radio">How do I choose the beneficiaries for my Will?
                     <div class="inner"></div>
                  </label>
               </li>
               <li>
                  <label for="accordion_5">
                     <input class="toggle" id="accordion_5" name="accordion" type="radio">Is it expensive to make a Will?
                     <div class="inner"> </div>
                  </label>
               </li>
               <li>
                  <label for="accordion_6">
                     <input class="toggle" id="accordion_6" name="accordion" type="radio">I am concerned about the legal process.
                     <div class="inner"></div>
                  </label>
               </li>
            </ul>
    ...
    <div class="container">
       <div class="row">
          <div class="col-12 action3_b u-align--center">
             ...
             <a class="btn p-button" target="_blank" href="https://mylaegacy.life.gov.sg/find-a-service/lpa-acp/">Get Started</a>
          </div>
       </div>
    </div>
 </section>